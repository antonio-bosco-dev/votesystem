...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color: white " >
    ...
    <section class="content-header" style="color:black ; font-size: 17px; ">
      <h1><b>
      Dashboard
      </b></h1>
      <ol class="breadcrumb" style="color:black ; font-size: 17px; ">
        <li><a href="#"><i class="fa fa-dashboard" ></i> Home</a></li>
        <li class="active" style="color:black ; font-size: 17px; " >Dashboard</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row"  >
      <div class="col-lg-3 col-xs-6" style=" font-family:'Bebas Neue', sans-serif;">
          <!-- small box -->
        ...
        <div class="col-lg-3 col-xs-6" style=" font-family:'Bebas Neue', sans-serif;">
          ...
          <div class="inner" style="background-color: #B59B91 ;color:black ; font-size:15px; font-family:'Bebas Neue', sans-serif;">
              <?php
        ...
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" style="color:black ; font-size: 15px; font-family:'Bebas Neue', sans-serif;">
          <!-- small box -->
          <div class="small-box bg-red">
          <div class="inner" style="background-color: #778899 ;color:black ; font-size:15px; font-family:'Bebas Neue', sans-serif;">
              <?php
                //$sql = "SELECT * FROM votes GROUP BY voters_id";
                $sql = "SELECT * FROM votes";
                $query = $conn->query($sql);
                $numvotes = $query->num_rows;
                echo "<h3>".$numvotes."</h3>";
              ?>
      ...
      <div class="row" style="color:black ; font-size: 17px; font-family:'Bebas Neue', sans-serif;">
        <div class="col-xs-12" >
          <h3> <b>VOTES TALLY
            <span class="pull-right">
            
              <a href="print.php" class="btn btn-success btn-sm btn-curve" style="background-color: #2E8B57 ;color:black ; font-size: 12px; font-family:'Bebas Neue', sans-serif; "><span class="glyphicon glyphicon-print"></span> Print</a>
            </span>
         </b> </h3>
        </div>
      </div>
