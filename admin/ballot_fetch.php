<?php
	...
	while($row = $query->fetch_assoc()){
		...
		$output .= '
			<div class="row">
				<div class="col-xs-12">
					<div class="box box-solid"style="background-color: white" id="'.$row['id'].'">
						...
						<div class="box-body">
							<p>'.$instruct.'
								<span class="pull-right">
									<button type="button" class="btn btn-success btn-sm btn-curve reset" style="background-color:#9CD095 ;color:black ; font-size: 12px; "  data-desc="'.slugify($row['description']).'"><i class="fa fa-refresh"></i> Reset</button>
								</span>
							</p>
